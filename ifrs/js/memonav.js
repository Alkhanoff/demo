...
function changeMemo(vis)
{
	parent.contentF.document.getElementById("memoPage"+parent.currentPageNo+"Text").style.visibility = vis;
	parent.contentF.document.getElementById("memoPage"+parent.currentPageNo+"Background").style.visibility = vis;
}
