...
<div id="navigation-breadcrumb" class="navigation">
	...
	<a href="{base_url}"><?=$this->section_model->getSectionName(1)?></a> <span class="separator">›</span> <a href="{base_url}services/"><?=$this->section_model->getSectionName(3)?></a> <span class="separator">›</span> <a href="{base_url}services/business_services/"><?=$this->section_model->getSectionName(17)?></a> <span class="separator">›</span> <span class="current"><?=$this->section_model->getSectionName(38)?></span>
    </div>
</div>
