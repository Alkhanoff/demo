    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="span-17 content news detail">
          <form method="post" action="{site_url}careers/login/">
				<table style="width:95%;height:170px;">
					<tr>
						<td style="text-align:left;font-size:25px;"><?=$this->section_model->getSectionName(116)?></td>
					</tr>
					...
					<tr>
						<td style="color:#f00;text-align:left;">{login_fail}</td>
					</tr>
					<tr>						
