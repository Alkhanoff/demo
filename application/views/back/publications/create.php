	...
	<div class="row">
		<div class="col-12">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title">Yeni Nəşr Yarat</h4>
				...
				<div class="card-content collapse show">
					<div class="card-body">
            <form method="post" enctype="multipart/form-data" action="<?php echo base_url('Admin/create_publications'); ?>">
        ...
        <textarea class="summernote2" name="text_en"></textarea>
          ...
          <button class="btn btn-primary mt-2" type="submit">Yadda Saxla</button>
            <button class="btn btn-info mt-2 ml-3" href="<?php echo base_url('Admin/publications'); ?>" >Geri Qayıt</button>
        </form>
