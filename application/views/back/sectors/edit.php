            ...
            <div class="breadcrumbs-top float-md-right">
              <div class="breadcrumb-wrapper mr-1">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">Sektor Bölmələr
                  </li>
                </ol>
              </div>
            </div>
	...
	<div class="row">
		<div class="col-12">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title">Sektor Bölmələri Redaktə</h4>
				...
				<div class="card-content collapse show">
					<div class="card-body">
            <form method="post" enctype="multipart/form-data" action="<?php echo base_url('Admin/update_sector_group'); ?>">
        ...
        <textarea class="summernote2" name="text_en" ><?php echo $item['text_en']; ?></textarea>
          ...
          <button class="btn btn-primary mt-2" type="submit">Dəyiş</button>
            <button class="btn btn-info mt-2 ml-3" href="<?php echo base_url('Admin/sectorgroups'); ?>" >Geri Qayıt</button>
        </form>
