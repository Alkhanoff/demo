      ...
      <div class="content-wrapper">
        ...
        <div class="content-header row">
          <div class="content-header-left col-md-4 col-12 mb-2">
            <h3 class="content-header-title">Vakansiyalar</h3>
          </div>
            ...
            <div class="breadcrumbs-top float-md-right">
              <div class="breadcrumb-wrapper mr-1">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="#">Karyera</a>
                  </li>
                  <li class="breadcrumb-item active">Vakansiyalar
                  </li>
                </ol>
              </div>
            </div>
	...
	<div class="row">
		<div class="col-12">
			<div class="card">
				...
				<div class="card-content collapse show">
					<div class="card-body">
            <form method="post" enctype="multipart/form-data" action="<?php echo base_url('Admin/create_vacancy'); ?>">
              <div class="form-group mt-2">
                  ...
                  <div class="form-group mt-2">
                        <div class="row">
                              <div class="col-sm-6 ">
                                  <label for="">Vəzifə Azərbaycanca</label>
                                <input type="text" name="position_az" class="form-control" >
                            </div>

                            <div class="col-sm-6 ">
                              <label for="">Vəzifə İngiliscə</label>
                      ...
                      <div class="form-group mt-2">
                            <div class="row">
                                  <div class="col-sm-6 ">
                                      <label for="">Sektor Azərbaycanca</label>
                                    <input type="text" name="sector_az" class="form-control" >
                                </div>

                                <div class="col-sm-6 ">
                                  <label for="">Sektor İngiliscə</label>
        ...
        <textarea class="summernote2" name="text_en"></textarea>
          ...
          <button class="btn btn-primary mt-2" type="submit">Yadda Saxla</button>
             ...
             <a class="btn btn-info mt-2 ml-3" href="<?php echo site_url('Admin/servicegroups'); ?>" >Geri Qayıt</a>
					</div>
				</div>
			</div>
		</div>
