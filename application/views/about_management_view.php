      ...
      <div class="row"><div class="span-12">
        ...
        <div class="span-15 content" style="width:70%;">
            ...
            <div class="full-width offset-12">
				...
				<a href="{base_url}about/management/narmin_hajiyeva/" class="panel-1 uniform-2" style="width:325px;">
                    ...
                    <img width="160" src="{base_url}images/management/narmin_hajiyeva_small.jpg" alt="" />
                    <span class="link" href="{base_url}about/management/narmin_hajiyeva/"><?php echo ($lang == 'en')? 'Read more' : 'Ətraflı oxu';?></span>
                </a>
                <a href="{base_url}about/management/azer_akbarov/" class="panel-1 odd uniform-2" style="width:325px;">
                ...
                <a href="{base_url}about/management/teymur_naghiyev/" class="panel-1 uniform-1" style="width:325px;">
                    <h4 <?php echo ($lang == 'az' ? 'style="font-family:Tahoma;"' : '')?>><?=$this->section_model->getSectionName(122)?></h4>
                    <p id="area_11" {display_inline_editor}>{area_11}</p>
                    <img width="160" src="{base_url}images/management/teymur_naghiyev_small.jpg" alt="" />
                    <span class="link" href="{base_url}about/management/teymur_naghiyev/"><?php echo ($lang == 'en')? 'Read more' : 'Ətraflı oxu';?></span>
                </a> 
            </div>
...
<div id="content-primary" class="content">
	...
	<table>
		...
		<tr>
			<td>
				<h2 class='line'>
					<a href="{base_url}about/management/narmin_hajiyeva/">
				...
				<p> 
					<a href="{base_url}about/management/narmin_hajiyeva/"><img width="160" src="{base_url}images/management/rena_isayeva_small.jpg" alt="" /></a>
				</p>
				<p style="padding:0;margin-top:15px;">
					<a style="background: url('{base_url}images/bullet.gif') no-repeat 0 0.5em;padding-left:10px;" href="{base_url}about/management/narmin_hajiyeva/"><?php echo ($lang == 'en')? 'Read more' : 'Ətraflı oxu';?></a>
				</p>
			</td>
			<td>				
				<h2 class='line'>
