		...
		public function management($person=''){
            ...
            switch ($person) {
                ...
                case 'azad_huseynov' : {
                    ...
                    break; }    
                case 'teymur_naghiyev' : {
                    $this->header('popular', 122); 
                    $left_menu = $this->section_model->getLeftMenu(122);
                    $details = $this->content_model->getArticleDetails(122);
                    break; }  
                default : {
                    $this->header('popular', 10);
                    $left_menu = $this->section_model->getLeftMenu(10);
			...
			switch ($person) {
				...
				case 'narmin_hajiyeva' : $this->parser->parse('about_management_narmin_hajiyeva_view', $data_body); break;
				...
				case 'teymur_naghiyev' : $this->parser->parse('about_management_teymur_naghiyev_view', $data_body); break;
			}            
            #End Body
